                      ...
                      child: Column(
                        children: [
                          ...
                          AppText(
                              ...
                              textSize: 22,
                              text:
                                  "Emosound adalah aplikasi yang dirancang untuk membantu penyandang tunarungu memahami keadaan emosi pembicara selama berkomunikasi (dengan berkomunikasi secara real time atau melampirkan file audio) dengan mengevaluasi dan menampilkan keadaan emosi pembicara dalam catatan suara (senang, netral, sedih, dll. ) serta transkripnya."),
                          SizedBox(height: SizeConfigManger.bodyHeight * .04),
                          Image.asset(
                            AssetsManger.logo,
